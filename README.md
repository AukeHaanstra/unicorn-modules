...
plus Java modules. The code is in a somewhat earlier version than that of the unicorn-simple and unicorn-hexagonal
projects, but the main points are clearly illustrated here.
